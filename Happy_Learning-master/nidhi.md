...
* #### Future Scope of this project are:
    ...
    * _The system is helpful for persons having learning disabilities or are visually challenged.
    ...
    * Easy to use.
    * Help improving spelling, reading, writing skills_.
